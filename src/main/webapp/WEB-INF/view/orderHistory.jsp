...
<style>
    ...
    .item-option { background-color: #f0f0f0; padding: 5px 10px; border-radius: 4px; text-align: center; font-size: 16px; }
    ...
    .btn-checkout { background-color: #444; }
            ...
            <c:otherwise>
                <c:forEach var="order" items="${ovm.orderHistorys}">
                    <div class="history-row">
                        ...
                        <div class="item-price">${order.productPrice}円</div>
